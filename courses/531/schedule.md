...
The texts that we will use for our discussion of stories include the following: Connell’s “The Most Dangerous Game” ([URL](https://loristics.net/texts/mdg.html)), Conrad’s _Heart of Darkness_ ([URL](https://loristics.net/texts/hod.html)), _Casablanca_ (1942), _Star Wars: A New Hope_ (1977) — because Lucas helped revive Campbell), and _Die Hard_ (1988), but feel free to bring examples of your own: there are pyramids and circles (and beats and whatever else) everywhere you turn.
